...
export const api = {
  ...
  addCountdown: (name, emoji, date, color, hideAfterDays) => post('/countdowns/add', { name, emoji, date, color, hideAfterDays }),
  deleteCountdown: (id) => del(`/countdowns/${id}`),
  updateCountdown: (id, name, emoji, date, color, hideAfterDays) => post('/countdowns/update', { id, name, emoji, date, color, hideAfterDays }),
