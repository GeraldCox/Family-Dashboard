...
export const api = {
  ...
  editChore: (personId, choreId, patch) => post('/chores/edit', { personId, choreId, ...patch }),
  reorderChores: (personId, choreIds) => post('/chores/reorder', { personId, choreIds }),
  ...
  editUpForGrabsChore: (choreId, patch) => post('/chores/up-for-grabs/edit', { choreId, ...patch }),
  reorderUpForGrabsChores: (choreIds) => post('/chores/up-for-grabs/reorder', { choreIds }),
  ...
  rateWeeklyMeal: (date, mealName, stars, note, personId) => post('/meals/rate-weekly', { date, mealName, stars, note, personId }),
  ...
  getSpoonacularSettings: () => get('/spoonacular/settings'),
  saveSpoonacularSettings: (apiKey) => post('/spoonacular/settings', { apiKey }),
  getMealLibrary: () => get('/meal-library'),
  saveMealToLibrary: (meal) => post('/meal-library/save', meal),
  rateMeal: (mealName, stars, note, date, personId) => post('/meal-library/rate', { mealName, stars, note, date, personId }),
