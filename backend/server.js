...
function geocodeLabel(place) {
  if (place.country === 'United States' && US_STATE_ABBR[place.admin1]) {
    return [place.name, US_STATE_ABBR[place.admin1]].filter(Boolean).join(', ');
  }
